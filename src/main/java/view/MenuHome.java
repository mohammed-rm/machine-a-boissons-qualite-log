...
public class MenuHome {
    ...
    private final JLabel labSoups;
    private final JLabel labSB;
    private final JLabel labAmericano;
    private final JLabel labLatte;
    private final JLabel labBT;
    private final JLabel labGT;
    private final JLabel labTomato;
    private DialogueFrame frame;
    private final ConnectionDB connection;

    public MenuHome(ConnectionDB conn) {
        this.connection = conn;
        DrinkDAO drinkDAO = new DrinkDAO(connection.getConn());
